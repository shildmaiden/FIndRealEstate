package com.fire.findrealestate.repository;

import com.fire.findrealestate.FIndRealEstateApp;
import com.fire.findrealestate.config.Constants;
import com.fire.findrealestate.config.audit.AuditEventConverter;
import com.fire.findrealestate.domain.PersistentAuditEvent;
...
import static com.fire.findrealestate.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
